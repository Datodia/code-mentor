...
export default function DeleteCourse({courseId, showDeleteModal, setShouldFetch, setShowDeleteModal}: PropType) {
                ...
                <div className='mt-10 flex gap-4'>
                    <Button onClick={() => setShowDeleteModal(prev => !prev)} variant={'outline'}>Cancel</Button>
                    {
                        loading ?
                            ...
                            <Button onClick={() => handleDelete(courseId!)} variant={'destructive'}>Delete</Button>
                    }
