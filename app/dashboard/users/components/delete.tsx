...
export default function DeleteModal({ userId, setShouldFetch, setShowDeleteModal, showDeleteModal }: PropType) {
                ...
                <div className='mt-10 flex gap-4'>
                    <Button onClick={() => setShowDeleteModal(prev => !prev)} variant={'outline'}>Cancel</Button>
                    {
                        loading ?
                            ...
                            <Button onClick={() => handleDelete(userId!)} variant={'destructive'}>Delete</Button>
                    }
